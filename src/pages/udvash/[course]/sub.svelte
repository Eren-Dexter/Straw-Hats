  ...
  udvash: {
    ...
    VarsityKAExamBatch: {
        ...
        hm1: [
        {
          ...
          syllabus: "Full Book",
          time: "30 mins",
          link: "https://forms.gle/BigtoJVMTnsGLqrF8"
        },
        {
          exam: "Paper Final",
          type: "MCQ",
    ...
    let newState, newIcon, courseName;
    courseName = store.udvash[window.location.pathname.split('/')[2]];
...
<div id="foo" class="grid xl:grid-cols-3 justify-items-center md:-ml-28 md:mr-14 mt-2 gap-4 h-100 p-4 pr-4 { courseName[state].length > 0 ? 'overflow-scroll overflow-x-hidden': ''}"> 

    {#if courseName[state].length > 0}
    {#each courseName[state] as sub}
    <section class="text-gray-600 body-font">
        <div class="border border-gray-200 p-6 rounded-lg transition duration-300 transform hover:scale-105 ease-in-out cursor-pointer shadow-md">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">{newState} - {sub.syllabus}</h2>
